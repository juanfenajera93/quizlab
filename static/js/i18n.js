...
(function () {
  ...
  var STRINGS = {
    es: {
      ...
      offline_n: '{n} sin conexión (reconectando)',
      offline_hint: 'Sin conexión — se reconectará solo. Clic para sacar de la sala.',
      stop_quiz: '■ Detener Quiz',
      reveal_now: 'Revelar',
      next: 'Siguiente →',
      live_answers: 'Respuestas en vivo',
      answered_of: '{n}/{m} respondieron',
      ...
      room_lost_recreated: 'Se perdió la sala anterior y se creó una nueva. Vuelve a compartir el código/QR con los estudiantes.',
    ...
    en: {
      ...
      offline_n: '{n} offline (reconnecting)',
      offline_hint: 'Offline — will reconnect on its own. Click to remove from the room.',
      stop_quiz: '■ Stop Quiz',
      reveal_now: 'Reveal',
      next: 'Next →',
      live_answers: 'Live Answers',
      answered_of: '{n}/{m} answered',
      ...
      room_lost_recreated: 'The previous room was lost and a new one was created. Re-share the QR/code with students.',
